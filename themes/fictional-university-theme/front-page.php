...
<div class="page-banner">
  <div class="page-banner__bg-image"
    style="background-image: url(<?php echo get_theme_file_uri('/css/images/library-hero.jpg') ?>)"></div>
  ...
  <div data-glide-el="track" class="glide__track">
    <div class="glide__slides">
      <div class="hero-slider__slide"
        style="background-image: url(<?php echo get_theme_file_uri('/css/images/bus.jpg)') ?>">
      ...
      <div class="hero-slider__slide"
        style="background-image: url(<?php echo get_theme_file_uri('/css/images/apples.jpg') ?>)">
        <div class="hero-slider__interior container">
          <div class="hero-slider__overlay">
      ...
      <div class="hero-slider__slide"
        style="background-image: url(<?php echo get_theme_file_uri('/css/images/bread.jpg') ?>)">
        <div class="hero-slider__interior container">
          <div class="hero-slider__overlay">
